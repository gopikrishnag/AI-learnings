...
with project_client:
    ...
    #upload a file
    file = project_client.agents.upload_file_and_poll(file_path='OOPs.pdf', purpose=FilePurpose.AGENTS)
    ...
    message = project_client.agents.create_message(
        thread_id=thread.id, role="user", content="why do we need to use  Abstract class?", attachments=[]
    )
